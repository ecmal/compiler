...
namespace ts {
    ...
    export function createTypeChecker(host: TypeCheckerHost, produceDiagnostics: boolean): TypeChecker {
        ...
        function resolveDecorator(node: Decorator, candidatesOutArray: Signature[]): Signature {
            const funcType:any = checkExpression(node.expression);
            return anySignature;
        }
        ...
        function getTypeReferenceSerializationType(typeName: EntityName): Type {
        ...
        function createResolver(): EmitResolver {
            return {
                ...
                getTypeReferenceSerializationType,
                resolveEntityName,
                isOptionalParameter,
