...
declare namespace ts.elc {
    function cla(args: string[]): {
        options: CompilerOptions;
        projects: string[];
        errors: Diagnostic[];
    };
...
declare namespace ts {
    ...
    class Project {
        ...
        private sourceDirectoryWatcher;
        private sourceFileWatchers;
        getId(): string;
        getName(): string;
        ...
        getOutputOptions(): ProjectOptions;
        getOutputOptionsContent(): string;
        getReporter(): DiagnosticReporter;
        constructor(service: ProjectService, filename: string, options: ProjectOptions);
        compile(): void;
        watch(): void;
        private doCompile();
        private onConfigFileChange(filename);
        private onFileChange(filename);
        private onDirectoryChange(filename);
    }
    class DiagnosticReporter {
        ...
        reportCompilerDiagnostic(message: DiagnosticMessage, ...args: (string | number)[]): void;
        reportWatchDiagnostic(message: DiagnosticMessage, ...args: (string | number)[]): void;
