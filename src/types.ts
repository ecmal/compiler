...
export interface INode extends TextRange {
    ...
    parent?: INode;                                  // Parent node (initialized by binding
    /* @internal */
    ...
    /* @internal */
    nextContainer?: INode;           // Next container in declaration order (initialized by binding)
    /* @internal */
...
export interface Modifier extends INode {
}
...
export interface QualifiedName extends INode {
...
export interface Declaration extends INode {
...
export interface ComputedPropertyName extends INode {
    expression: Expression;
}

// @kind(SyntaxKind.Decorator)
export interface Decorator extends INode {
...
export interface VariableDeclarationList extends INode {
    declarations: NodeArray<VariableDeclaration>;
}

// @kind(SyntaxKind.Parameter)
export interface ParameterDeclaration extends Declaration {
    dotDotDotToken?: INode;              // Present on rest parameter
    name: Identifier | BindingPattern;  // Declared parameter name
    questionToken?: INode;               // Present on optional parameter
    type?: TypeNode;                    // Optional type annotation
    initializer?: Expression;           // Optional initializer
}
...
export interface BindingElement extends Declaration {
    ...
    dotDotDotToken?: INode;              // Present on rest binding element
...
export interface PropertySignature extends TypeElement {
    ...
    questionToken?: INode;               // Present on optional property
    type?: TypeNode;                    // Optional type annotation
    initializer?: Expression;           // Optional initializer
}
...
export interface PropertyDeclaration extends ClassElement {
    questionToken?: INode;               // Present for use with reporting a grammar error
    name: PropertyName;
    type?: TypeNode;
    initializer?: Expression;           // Optional initializer
}
...
export interface BindingPattern extends INode {
...
export interface TypeNode extends INode {
    _typeNodeBrand: any;
}
...
export interface Expression extends INode {
    ...
    contextualType?: IType;  // Used to temporarily assign a contextual type during overload resolution
}
...
export interface ArrowFunction extends Expression, FunctionLikeDeclaration {
    equalsGreaterThanToken: INode;
    body: ConciseBody;
}

export interface LiteralLikeNode extends INode {
    text: string;
...
export interface TemplateSpan extends INode {
    expression: Expression;
...
export interface JsxAttribute extends INode {
    name: Identifier;
...
export interface JsxSpreadAttribute extends INode {
    expression: Expression;
}

// @kind(SyntaxKind.JsxClosingElement)
export interface JsxClosingElement extends INode {
    tagName: EntityName;
}
...
export interface JsxText extends INode {
...
export interface CaseBlock extends INode {
    clauses: NodeArray<CaseOrDefaultClause>;
}

// @kind(SyntaxKind.CaseClause)
export interface CaseClause extends INode {
    expression: Expression;
    statements: NodeArray<Statement>;
}

// @kind(SyntaxKind.DefaultClause)
export interface DefaultClause extends INode {
    statements: NodeArray<Statement>;
}
...
export interface CatchClause extends INode {
...
export interface HeritageClause extends INode {
    token: SyntaxKind;
...
export interface ModuleBlock extends INode, Statement {
    statements: NodeArray<Statement>;
}
...
export interface ExternalModuleReference extends INode {
    expression?: Expression;
}
...
export interface NamedImports extends INode {
    elements: NodeArray<ImportSpecifier>;
}

// @kind(SyntaxKind.NamedExports)
export interface NamedExports extends INode {
...
export interface JSDocTypeExpression extends INode {
    type: JSDocType;
}
...
export interface JSDocComment extends INode {
    tags: NodeArray<JSDocTag>;
}

// @kind(SyntaxKind.JSDocTag)
export interface JSDocTag extends INode {
    atToken: INode;
    tagName: Identifier;
}
...
export interface SourceFile extends Declaration {
    ...
    /* @internal */
    externalModuleIndicator: INode;
    // The first node that causes this file to be a CommonJS module
    /* @internal */
    commonJsModuleIndicator: INode;
...
export interface TypeChecker {
    getTypeOfSymbolAtLocation(symbol:Symbol, node:INode): IType;
    getDeclaredTypeOfSymbol(symbol:Symbol): IType;
    getPropertiesOfType(type:IType): Symbol[];
    getPropertyOfType(type:IType, propertyName:string): Symbol;
    getSignaturesOfType(type:IType, kind:SignatureKind): ISignature[];
    getIndexTypeOfType(type:IType, kind:IndexKind): IType;
    getBaseTypes(type:InterfaceType): ObjectType[];
    getReturnTypeOfSignature(signature:ISignature): IType;

    getSymbolsInScope(location:INode, meaning:SymbolFlags): Symbol[];
    getSymbolAtLocation(node:INode): Symbol;
    getSymbolsOfParameterPropertyDeclaration(parameter:ParameterDeclaration, parameterName:string): Symbol[];
    getShorthandAssignmentValueSymbol(location:INode): Symbol;
    getExportSpecifierLocalTargetSymbol(location:ExportSpecifier): Symbol;
    getTypeAtLocation(node:INode): IType;
    typeToString(type:IType, enclosingDeclaration?:INode, flags?:TypeFormatFlags): string;
    symbolToString(symbol:Symbol, enclosingDeclaration?:INode, meaning?:SymbolFlags): string;
    getSymbolDisplayBuilder(): SymbolDisplayBuilder;
    getFullyQualifiedName(symbol:Symbol): string;
    getAugmentedPropertiesOfType(type:IType): Symbol[];
    getRootSymbols(symbol:Symbol): Symbol[];
    getContextualType(node:Expression): IType;
    getResolvedSignature(node:CallLikeExpression, candidatesOutArray?:ISignature[]): ISignature;
    getSignatureFromDeclaration(declaration:SignatureDeclaration): ISignature;
    ...
    getJsxElementAttributesType(elementNode:JsxOpeningLikeElement): IType;
...
export interface SymbolDisplayBuilder {
    buildTypeDisplay(type:IType, writer:SymbolWriter, enclosingDeclaration?:INode, flags?:TypeFormatFlags): void;
    buildSymbolDisplay(symbol:Symbol, writer:SymbolWriter, enclosingDeclaration?:INode, meaning?:SymbolFlags, flags?:SymbolFormatFlags): void;
    buildSignatureDisplay(signatures:ISignature, writer:SymbolWriter, enclosingDeclaration?:INode, flags?:TypeFormatFlags, kind?:SignatureKind): void;
    buildParameterDisplay(parameter:Symbol, writer:SymbolWriter, enclosingDeclaration?:INode, flags?:TypeFormatFlags): void;
    buildTypeParameterDisplay(tp:TypeParameter, writer:SymbolWriter, enclosingDeclaration?:INode, flags?:TypeFormatFlags): void;
    buildTypePredicateDisplay(predicate:TypePredicate, writer:SymbolWriter, enclosingDeclaration?:INode, flags?:TypeFormatFlags): void;
    buildTypeParameterDisplayFromSymbol(symbol:Symbol, writer:SymbolWriter, enclosingDeclaration?:INode, flags?:TypeFormatFlags): void;
    buildDisplayForParametersAndDelimiters(parameters:Symbol[], writer:SymbolWriter, enclosingDeclaration?:INode, flags?:TypeFormatFlags): void;
    buildDisplayForTypeParametersAndDelimiters(typeParameters:TypeParameter[], writer:SymbolWriter, enclosingDeclaration?:INode, flags?:TypeFormatFlags): void;
    buildReturnTypeDisplay(signature:ISignature, writer:SymbolWriter, enclosingDeclaration?:INode, flags?:TypeFormatFlags): void;
}
...
export interface SymbolWriter {
    ...
    trackSymbol(symbol:Symbol, enclosingDeclaration?:INode, meaning?:SymbolFlags): void;
...
export interface SymbolVisibilityResult {
    ...
    errorNode?: INode; // optional node that results in error
}
...
export interface EmitResolver {
    ...
    isValueAliasDeclaration(node:INode): boolean;
    isReferencedAliasDeclaration(node:INode, checkChildren?:boolean): boolean;
    isTopLevelValueImportEqualsWithEntityName(node:ImportEqualsDeclaration): boolean;
    getNodeCheckFlags(node:INode): NodeCheckFlags;
    isDeclarationVisible(node:Declaration): boolean;
    collectLinkedAliases(node:Identifier): INode[];
    isImplementationOfOverload(node:FunctionLikeDeclaration): boolean;
    writeTypeOfDeclaration(declaration:AccessorDeclaration | VariableLikeDeclaration, enclosingDeclaration:INode, flags:TypeFormatFlags, writer:SymbolWriter): void;
    writeReturnTypeOfSignatureDeclaration(signatureDeclaration:SignatureDeclaration, enclosingDeclaration:INode, flags:TypeFormatFlags, writer:SymbolWriter): void;
    writeTypeOfExpression(expr:Expression, enclosingDeclaration:INode, flags:TypeFormatFlags, writer:SymbolWriter): void;
    isSymbolAccessible(symbol:Symbol, enclosingDeclaration:INode, meaning:SymbolFlags): SymbolAccessiblityResult;
    isEntityNameVisible(entityName:EntityName | Expression, enclosingDeclaration:INode): SymbolVisibilityResult;
...
export interface SymbolLinks {
    ...
    type?: IType;                        // Type of value symbol
    declaredType?: IType;                // Type of class, interface, enum, type alias, or type parameter
    typeParameters?: TypeParameter[];   // Type parameters of type alias (undefined if non-generic)
    inferredClassType?: IType;           // Type of an inferred ES5 class
    instantiations?: Map<IType>;         // Instantiations of generic type alias (undefined if non-generic)
...
export interface NodeLinks {
    resolvedType?: IType;              // Cached type of type node
    resolvedAwaitedType?: IType;       // Cached awaited type of type node
    resolvedSignature?: ISignature;    // Cached signature of signature node or call expression
    ...
    resolvedJsxType?: IType;           // resolved element attributes type of a JSX openinglike element
...
export interface IntrinsicType extends IType {
    intrinsicName: string;  // Name of intrinsic type
}

// String literal types (TypeFlags.StringLiteral)
export interface StringLiteralType extends IType {
...
export interface InterfaceType extends ObjectType {
    ...
    /* @internal */
    resolvedBaseConstructorType?: IType;        // Resolved base constructor type of class
    /* @internal */
...
export interface InterfaceTypeWithDeclaredMembers extends InterfaceType {
    ...
    declaredCallSignatures: ISignature[];       // Declared call signatures
    declaredConstructSignatures: ISignature[];  // Declared construct signatures
    declaredStringIndexType: IType;             // Declared string index type
    declaredNumberIndexType: IType;             // Declared numeric index type
}
...
export interface TypeReference extends ObjectType {
    ...
    typeArguments: IType[];  // Type reference type arguments (undefined if none)
}
...
export interface TupleType extends ObjectType {
    elementTypes: IType[];  // Element types
}

export interface UnionOrIntersectionType extends IType {
    types: IType[];                    // Constituent types
    /* @internal */
    reducedType: IType;                // Reduced union type (all subtypes removed)
    /* @internal */
...
export interface ResolvedType extends ObjectType, UnionOrIntersectionType {
    ...
    callSignatures: ISignature[];       // Call signatures of type
    constructSignatures: ISignature[];  // Construct signatures of type
    stringIndexType?: IType;            // String index type
    numberIndexType?: IType;            // Numeric index type
}
...
export interface IterableOrIteratorType extends ObjectType, UnionType {
    iterableElementType?: IType;
    iteratorElementType?: IType;
}

// Type parameters (TypeFlags.TypeParameter)
export interface TypeParameter extends IType {
    constraint: IType;        // Constraint
    /* @internal */
    target?: TypeParameter;  // Instantiation target
    /* @internal */
    mapper?: TypeMapper;     // Instantiation mapper
    /* @internal */
    resolvedApparentType: IType;
}
...
export interface ISignature {
    ...
    /* @internal */
    resolvedReturnType: IType;           // Resolved return type
    /* @internal */
    ...
    /* @internal */
    target?: ISignature;                 // Instantiation target
    /* @internal */
    mapper?: TypeMapper;                // Instantiation mapper
    /* @internal */
    unionSignatures?: ISignature[];      // Underlying signatures of a union signature
    /* @internal */
    erasedSignatureCache?: ISignature;   // Erased version of signature (deferred)
    /* @internal */
...
export interface TypeMapper {
    (t:TypeParameter): IType;
    instantiations?: IType[];    // Cache of instantiations created using this type mapper.
...
export interface TypeInferences {
    primary: IType[];    // Inferences made directly to a type parameter
    secondary: IType[];  // Inferences made to a type parameter in a union type
...
export interface InferenceContext {
    ...
    inferredTypes: IType[];              // Inferred type for each type parameter
