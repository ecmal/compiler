...
import {
    SyntaxKind, LiteralExpression, StringLiteral, ImportOrExportSpecifier, Identifier, Declaration, NodeFlags,
    JSDocParameterTag, SignatureDeclaration, JSDocTemplateTag, JSDocReturnTag, ParameterDeclaration, ParserContextFlags,
    BindingPattern, BindingElement, ImportSpecifier, ExportAssignment, QualifiedName, EntityName, NodeArray,
    DiagnosticCollection, Map, SourceFile, Diagnostic, PropertyAccessExpression, TypeParameterDeclaration,
    VariableLikeDeclaration, FunctionLikeDeclaration, TypeAssertion, ReturnStatement, Block, YieldExpression,
    CommentRange, FileReference, DiagnosticMessage, ScriptReferenceHost, ClassLikeDeclaration, AccessorDeclaration,
    BinaryExpression, JSDocTypeTag, SymbolWriter, WriteFileCallback, TextSpan, MethodDeclaration, JSDocFunctionType,
    PropertyDeclaration, ResolvedModule, ModuleDeclaration, DeclarationName, DiagnosticMessageChain, CallExpression,
    ExpressionStatement, CharacterCodes, CallLikeExpression, Expression, TaggedTemplateExpression,
    ExpressionWithTypeArguments, TypeReferenceNode, TypeNode, ElementAccessExpression, Decorator,
    ComputedPropertyName, ForInStatement, ForOfStatement, AssertionExpression, TemplateSpan, ForStatement,
    SpecialPropertyAssignmentKind, ImportEqualsDeclaration, ImportDeclaration, ExternalModuleReference,
    ExportDeclaration, JSDocTag, JSDocComment, VariableDeclaration, InterfaceDeclaration, HeritageClause,
    CompilerOptions, ScriptTarget, ModuleKind, JsxEmit, LanguageVariant, NewLineKind, TextRange, TypePredicate,
    IdentifierTypePredicate, TypePredicateKind, ThisTypePredicate, ConstructorDeclaration, ImportClause,
    ObjectLiteralExpression, ArrayLiteralExpression, TextChangeRange, LabeledStatement, Symbol, INode as Node,
    TypePredicateNode, TypeQueryNode, TypeLiteralNode, ArrayTypeNode, TupleTypeNode, UnionOrIntersectionTypeNode,
    ParenthesizedTypeNode, ParenthesizedExpression, DeleteExpression, TypeOfExpression, VoidExpression,
    PrefixUnaryExpression, AwaitExpression, PostfixUnaryExpression, AsExpression, ConditionalExpression,
    SpreadElementExpression, VariableStatement, VariableDeclarationList, IfStatement, DoStatement, WhileStatement,
    BreakOrContinueStatement, WithStatement, SwitchStatement, CaseBlock, DefaultClause, CaseClause, ThrowStatement,
    TryStatement, CatchClause, ClassDeclaration, TypeAliasDeclaration, EnumDeclaration, EnumMember, NamespaceImport,
    NamedImportsOrExports, TemplateExpression, JsxElement, JsxOpeningLikeElement, JsxAttribute, JsxSpreadAttribute,
    JsxExpression, JsxClosingElement, JSDocTypeExpression, JSDocUnionType, JSDocTupleType, JSDocArrayType,
    JSDocNonNullableType, JSDocNullableType, JSDocRecordType, JSDocTypeReference, JSDocOptionalType, JSDocVariadicType,
    JSDocConstructorType, JSDocThisType, JSDocRecordMember, TypeElement, TemplateLiteralFragment, StringLiteralTypeNode,
    LiteralLikeNode, FunctionExpression, NewExpression, ModifiersArray, PropertyName, ClassElement, JsxChild,
    LeftHandSideExpression, ArrowFunction, PropertySignature, MethodSignature, UnaryExpression, JsxSelfClosingElement,
    JsxText, PrimaryExpression, PropertyAssignment, ShorthandPropertyAssignment, ThisTypeNode, CallSignatureDeclaration,
    ConstructSignatureDeclaration, IndexSignatureDeclaration, FunctionOrConstructorTypeNode, MemberExpression,
    IncrementExpression, JsxOpeningElement, ObjectLiteralElement, Statement, IterationStatement, CaseOrDefaultClause,
    FunctionDeclaration, ClassExpression, SemicolonClassElement, ModuleBlock, NamedImports, JSDocType, JSDocUnknownType,
    JSDocAllType, TypeCheckerHost, TypeChecker, CancellationToken, SymbolFlags, SymbolTable, TypeFlags, ObjectType,
    GenericType, IType as Type, RelationComparisonResult, SymbolDisplayBuilder, ISignature as Signature, TupleType,
    UnionType, IntersectionType, StringLiteralType, SymbolLinks, NodeLinks, TransientSymbol, InterfaceType,
    AnyImportSyntax, ExportSpecifier, TypeReference, TypeParameter, SignatureKind, TypeFormatFlags,
    InterfaceTypeWithDeclaredMembers, IndexKind, TypeMapper, ResolvedType, AnonymousType, UnionOrIntersectionType,
    UnionTypeNode, IntersectionTypeNode, JSDocTypeReferencingNode, InferenceContext, FreshObjectLiteralType,
    TypeInferences, NodeCheckFlags, JsxFlags, IntrinsicType, SymbolAccessiblityResult, SymbolAccessibility,
    SymbolVisibilityResult, SymbolFormatFlags, IterableOrIteratorType, TypeReferenceSerializationKind, EmitResolver
} from "./types";
import {
    objectAllocator, sum, forEach, hasProperty, Debug, createCompilerDiagnostic, indexOf,
    concatenate, map, contains, filter, rangeEquals, lastOrUndefined, addRange, Ternary,
    concatenateDiagnosticMessageChains, chainDiagnosticMessages, copyMap, lookUp, forEachValue, memoize,
    createFileDiagnostic
} from "./core";
import {
    getEmitModuleKind, createDiagnosticCollection, createDiagnosticForNode,
    isGlobalScopeAugmentation, isExternalOrCommonJsModule, getSourceFileOfNode, getEnclosingBlockScopeContainer,
    isFunctionLike, isAmbientModule, getLocalSymbolForExportDefault, getDeclarationOfKind, isClassLike, isClassElement,
    declarationNameToString, getThisContainer, isBlockOrCatchScoped, getAncestor, isAliasSymbolDeclaration,
    getExternalModuleImportEqualsDeclarationExpression, isStringOrNumericLiteral, hasDynamicName, isBindingPattern,
    getSetAccessorTypeAnnotationNode, getClassExtendsHeritageClauseElement, getInterfaceBaseTypeNodes,
    isSupportedExpressionWithTypeArguments, getJSDocTemplateTag, getCorrespondingJSDocParameterTag, hasQuestionToken,
    isJSDocConstructSignature, nodeIsMissing, hasRestParameter, isNodeDescendentOf, isIdentifierTypePredicate,
    isObjectLiteralMethod, createDiagnosticForNodeFromMessageChain, getContainingFunction, getContainingClass,
    nodeIsDecorated, nodeStartsNewLexicalEnvironment, isIterationStatement, isAssignmentOperator, isSuperCallExpression,
    getSpecialPropertyAssignmentKind, isInJavaScriptFile, getJSDocTypeTag, isSuperPropertyOrElementAccess,
    getTextOfNode, getCombinedNodeFlags, getPropertyNameForKnownSymbolName, isWellKnownSymbolSyntactically,
    getJSDocReturnTag, isAsyncFunctionLike, forEachReturnStatement, escapeIdentifier, isExternalModuleNameRelative,
    getResolvedModule, isRightSideOfQualifiedNameOrPropertyAccess, isInternalModuleImportEqualsDeclaration,
    nodeIsPresent, isExternalModuleImportEqualsDeclaration, getSingleLineStringWriter, releaseStringWriter,
    isExternalModuleAugmentation, escapeString, isRestParameter, isInAmbientContext, getRootDeclaration,
    getSuperContainer, isIntrinsicJsxName, forEachYieldExpression, isRequireCall, isThisTypePredicate,
    isPrologueDirective, getEntityNameFromTypeNode, nodeCanBeDecorated, getFirstConstructorWithBody,
    isSourceFileJavaScript, modifierToFlag, isParameterDeclaration, getTextOfNodeFromSourceText,
    getClassImplementsHeritageClauseElements, isConst, isConstEnumDeclaration, isInstantiatedModule,
    getExternalModuleName, introducesArgumentsExoticObject, isDeclarationName,
    isExpressionWithTypeArgumentsInClassExtendsClause, isExpression, isTypeNode, isDeclaration, isStatementWithLocals,
    isBlockScopedContainerTopLevel, nodeIsSynthesized, getAllAccessorDeclarations, isDynamicName, isLet,
    getSpanOfTokenAtPosition, textSpanEnd
} from "./utilities";
import {Diagnostics} from "./diagnostics";
import {forEachChild} from "./parser";
import {skipTrivia, tokenToString, getLineAndCharacterOfPosition} from "./scanner";
import {ModuleInstanceState, getModuleInstanceState, bindSourceFile} from "./binder";
...
export function createTypeChecker(host:TypeCheckerHost, produceDiagnostics:boolean):TypeChecker {
    ...
    function createSymbol(flags:SymbolFlags, name:string):Symbol {
        symbolCount++;
        return <any>new Symbol(flags, name);
    }
    ...
    function isBlockScopedNameDeclaredBeforeUse(declaration:Declaration, usage:Node):boolean {
        ...
        if (declaration.pos <= usage.pos) {
            ...
            return declaration.kind !== SyntaxKind.VariableDeclaration || !isImmediatelyUsedInInitializerOfBlockScopedVariable(<VariableDeclaration>declaration, usage);
        }
            ...
            return forEachValue(symbols, symbolFromSymbolTable => {
                if (symbolFromSymbolTable.flags & SymbolFlags.Alias
                    ...
                    if (!useOnlyExternalAliasing || // We can use any type of alias to get the name
                        ...
                        forEach(symbolFromSymbolTable.declarations, isExternalModuleImportEqualsDeclaration)) {
    ...
    function hasVisibleDeclarations(symbol:Symbol):SymbolVisibilityResult {
        ...
        function getIsDeclarationVisible(declaration:Declaration) {
            if (!isDeclarationVisible(declaration)) {
                ...
                if (anyImportSyntax && !(anyImportSyntax.flags & NodeFlags.Export) && // import clause without export
            ...
            function walkSymbol(symbol:Symbol, meaning:SymbolFlags):void {
                if (symbol) {
                    ...
                    if (accessibleSymbolChain) {
                        ...
                        if (!parentSymbol && forEach(symbol.declarations, hasExternalModuleSymbol)) {
                            return;
                        }
        ...
        function determineIfDeclarationIsVisible() {
            switch (node.kind) {
                ...
                case SyntaxKind.VariableDeclaration:
                    if (isBindingPattern(node.name) && !(<BindingPattern>node.name).elements.length) {
                ...
                case SyntaxKind.ImportEqualsDeclaration:
                    ...
                    if (!(getCombinedNodeFlags(node) & NodeFlags.Export) && !(node.kind !== SyntaxKind.ImportEqualsDeclaration && parent.kind !== SyntaxKind.SourceFile && isInAmbientContext(parent))) {
    ...
    function isOptionalParameter(node:ParameterDeclaration) {
        ...
        if (node.initializer) {
            ...
            const parameterIndex = indexOf(signatureDeclaration.parameters, node);
    ...
    function resolveTypeReferenceName(node:TypeReferenceNode | ExpressionWithTypeArguments | JSDocTypeReference,
     ...
     */
    function checkTypeRelatedTo(source:Type,
                                target:Type,
    ...
    function getNarrowedTypeOfSymbol(symbol:Symbol, node:Node) {
        ...
        function narrowTypeByTypePredicate(type:Type, callExpression:CallExpression, assumeTrue:boolean):Type {
            ...
            if (isIdentifierTypePredicate(predicate)) {
                ...
                return narrowTypeByThisTypePredicate(type, <ThisTypePredicate>predicate, invokedExpression, assumeTrue);
            }
            return type;
        }
    ...
    function checkCallExpression(node:CallExpression):Type {
        ...
        if (node.kind === SyntaxKind.NewExpression) {
            ...
            if (declaration &&
                ...
                declaration.kind !== SyntaxKind.ConstructorType && !isJSDocConstructSignature(declaration)) {
    ...
    function checkTypePredicate(node:TypePredicateNode):void {
        ...
        const typePredicate = <IdentifierTypePredicate>getSignatureFromDeclaration(parent).typePredicate;
        if (!typePredicate) {
            return;
        }
    ...
    function checkIfTypePredicateVariableIsDeclaredInBindingPattern(pattern:BindingPattern,
    ...
    function checkConstructorDeclaration(node:ConstructorDeclaration) {
        ...
        function isInstancePropertyWithInitializer(n:Node):boolean {
            return n.kind === SyntaxKind.PropertyDeclaration && !(n.flags & NodeFlags.Static) && !!(<PropertyDeclaration>n).initializer;
        }
    ...
    function checkIndexConstraints(type:Type) {
        ...
        function checkIndexConstraintForProperty(prop:Symbol,
                                                 propertyType:Type,
                                                 containingType:Type,
    ...
    function getFirstNonAmbientClassOrFunctionDeclaration(symbol:Symbol):Declaration {
        ...
        for (const declaration of declarations) {
            if ((declaration.kind === SyntaxKind.ClassDeclaration ||
                (declaration.kind === SyntaxKind.FunctionDeclaration && nodeIsPresent((<FunctionLikeDeclaration>declaration).body))) && !isInAmbientContext(declaration)) {
                return declaration;
            }
        }
        return undefined;
