...
import {
    CharacterCodes, SyntaxKind, DiagnosticMessage, ScriptTarget, LineAndCharacter, CommentRange,
    LanguageVariant, Map, SourceFile
} from "./types";
import {lastOrUndefined, binarySearch} from "./core";
