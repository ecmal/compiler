...
/* @internal */
import {SourceMapData, SourceFile, TextRange, SourceMapSpan, CharacterCodes, INode as Node} from "./types";
import {EmitHost, EmitTextWriter, getSourceFilePathInNewDir, convertToBase64, stringify} from "./utilities";
import {
    normalizeSlashes,
    directorySeparator,
    Debug,
...
import {getLineAndCharacterOfPosition, skipTrivia} from "./scanner";
