...
import {createScanner, tokenToString, tokenIsIdentifierOrKeyword, skipTrivia, isOctalDigit} from "./scanner";
import {
...
namespace Parser {
    ...
    function fillSignature(returnToken:SyntaxKind,
...
namespace IncrementalParser {
    ...
    function updateTokenPositionsAndMarkElements(sourceFile:IncrementalNode,
                                                 changeStart:number,
