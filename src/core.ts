 ...
 */
import {
    DiagnosticMessageChain, FileMap, Map, ISignature, TypeChecker, TypeFlags, CompilerOptions, Path,
    DiagnosticMessage, Diagnostic, SourceFile, CharacterCodes, IType, SymbolFlags, SyntaxKind, INode, NodeFlags
} from "./types";
...
export function getDirectoryPath(path:string|Path):Path|string {
...
export interface ObjectAllocator {
    getNodeConstructor(): new (kind:SyntaxKind, pos?:number, end?:number) => INode;
    getSourceFileConstructor(): new (kind:SyntaxKind, pos?:number, end?:number) => SourceFile;
    getSymbolConstructor(): new (flags:SymbolFlags, name:string) => Symbol;
    getTypeConstructor(): new (checker:TypeChecker, flags:TypeFlags) => IType;
    getSignatureConstructor(): new (checker:TypeChecker) => ISignature;
}
