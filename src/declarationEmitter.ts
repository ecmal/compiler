...
import {getResolvedExternalModuleName, getExternalModuleNameFromDeclaration} from "./emitter";
import {getLeadingCommentRanges, getLineStarts} from "./scanner";
...
function emitDeclarations(host:EmitHost, resolver:EmitResolver, emitterDiagnostics:DiagnosticCollection, declarationFilePath:string,
    ...
    const emitJsDocComments = compilerOptions.removeComments ? function (declaration:Node) {
    } : writeJsDocComments;
